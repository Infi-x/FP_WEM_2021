...
public class Habitacion 
{
    ...
    public String getDescripcionLarga() {
        ...
        if (getElementos() == null) 
            s+="En esta habitación no hay nada.\n";
        else
            s+="En esta habitación podrás encontrar los siguientes objetos: "+getElementos()
            +"\n";
    ...
    public void agregarElemento(Elemento e) {
        elementos.addElemento(e);
    }
    
    public String getElementos() {
        String s = "";
        
        if (elementos.getElementos().isEmpty()) return null;
        
        for (Elemento cada: getElementos().values()) {
